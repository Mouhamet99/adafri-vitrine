<!-- Meta Tags  -->
<title>Push vocal | Publicité téléphone | Adafri</title>
<meta name="description" content="Campagne audio sur les téléphones. Activez vos pubs et messages vers vos cibles en toute langue. ">
<meta name="keywords" content="campagnes par vocal, voix, voice api, campagnes push vocal">

<?php
include("push-vocal.css.php");
echo (START_TAGS);
...
<section class="second-section py-5">
    <div class="container">
        <p class="text-center mb-5 pb-5">
            Envoyez et diffusez un message vocale <br> dans la langue de votre choix
            à vos clients en faisant sonner leurs téléphones. </p>
        <div class="row">
            ...
            <div class="col order-1 ">
                <div class="h-100 d-flex align-items-center justify-content-center">
                    <img src="<?php echo (WEB_ROOT . 'assets/images/slider7.png') ?>" alt="ring">
                </div>
            </div>
        </div>
    </div>
