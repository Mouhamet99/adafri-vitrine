      ...
      <div class="container">
        <div class="row py-5 text-nowrap text-center text-lg-start">
          ...
          <div class="col col-12 col-md-6 col-xl-3 mt-5 mt-md-0">
            ...
            <ul>
              <li><a href="<?php path('conditions-generales-utilisation') ?>" class="justify-content-center justify-content-lg-start">Conditions générales d’utilisation</a></li>
              <li><a href="<?php path('politique-confidentialite') ?>" class="justify-content-center justify-content-lg-start">Politique de confidentialité</a></li>
            </ul>
          </div>
          <div class="col col-12 col-md-6 col-xl-3 mt-5 mt-md-0">
